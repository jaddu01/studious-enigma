...
class CategoryAdsImage extends BaseModel
{
    use Translatable;

    public $translationModel = 'App\CategoryAdsImageTranslations';

    public  $locales;

    use SoftDeletes;
    protected $table = 'category_ads_image';
    protected $fillable = [
            ...
            case 'POST':
            {
                ...
                foreach ($this->locales as $locale) {
                    $trans = $trans + [
                            ...
                            'title:'.$locale => "required|unique:category_ads_image_translations,title",
                        ];
                }
                return $page + $trans;
            ...
            case 'PUT':
                ...
                foreach ($this->locales as $locale) {
                    $trans = $trans + [
                            ...
                            'title:'.$locale => 'required|unique:category_ads_image_translations,title,'.$id.',category_ads_image_id',
                        ];
                }
                return $page + $trans;
            case 'PATCH':
