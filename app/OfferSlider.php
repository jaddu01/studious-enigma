...
class OfferSlider extends BaseModel
{
    use Translatable;
    protected $table = 'offer_sliders';
    public $translationModel = 'App\OfferSliderTranslation';
    public  $locales;
    use SoftDeletes;
    protected $fillable = [
            ...
            case 'POST':
            {
                ...
                foreach ($this->locales as $locale) {
                    $trans = $trans + [
                            ...
                            'title:'.$locale => "required|unique:offer_slider_translations,title",
                        ];
                }
                return $page + $trans;
            ...
            case 'PUT':
                ...
                foreach ($this->locales as $locale) {
                    $trans = $trans + [
                            ...
                            'title:'.$locale => 'required|unique:offer_slider_translations,title,'.$id.',offer_slider_id',
                        ];
                }
                return $page + $trans;
            case 'PATCH':
