...
//die;
        $validator = Validator::make($input,$this->vendorCommission->rules($this->method,$id),$this->vendorCommission->messages($this->method));
...
//die;
            ...
            try {
                ...
                DB::commit();
                Session::flash('success','Commision updated successful');
            } catch (\Exception $e) {
                Session::flash('danger',$e->getMessage());
                DB::rollBack();
            }
