...
class RevenueController extends Controller
{
  ...
  /*  public function update(Request $request, $id)
    ...
    $vendors = $this->order->with(['ProductOrderItem','zone',"OrderStatusNew",'vendor','revenue'])->where('order_status','D')->select('*');
        ...
        $sum_total_amount = $sum_sub_total + $rawVendors->sum('delivery_charge') - $rawVendors->sum('admin_discount');
           ...
           ->addColumn('order_code',function ($newdata){
            ...
            ->addColumn('action',function ($newdata){
             ...
             ->with([
                ...
                'sum_vendor' =>  'N/A',
                'sum_sub_total'=> array_sum(array_column($newdata, 'sub_total')),
                'sum_total_amount'=>array_sum(array_column($newdata, 'total_amount')),
