    ...
    public function anyData(Request $request)
    {
        ...
        return Datatables::of($region)
            ...
            ->addColumn('action',function ($region){
                return '<a href="'.route("week-package.edit",$region->id).'" class="btn btn-success">Edit</a></br><button type="button" onclick="deleteRow('.$region->id.')" class="btn btn-danger">Delete</button><a href="'.route("week-package.show",$region->id).'" class="btn btn-success">View Details</a>';
            })
