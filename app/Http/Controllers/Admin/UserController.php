...
class UserController extends Controller
{
    ...
    public function store(Request $request)
    {
        $input = $request->all();
         ...
         if(!$request->has('access_user_id') || $request->has('access_user_id')== null || $request->has('access_user_id')== ''){
        ...
        if ($validator->fails()) {
            ...
            try {
                if($input['access_user_id'] == '' || $input['access_user_id'] == null){
                    $input['access_user_id']= 0;
                }
...
// dd($flight);
    ...
    public function changeStatus(Request $request){
        ...
        if($status == 0){
            ...
            echo "<pre>";
            echo "user_id_array=="; print_r($user_id_array);
            echo "dataArray=="; print_r($dataArray);
            echo "user_device_type=="; print_r($user_device_type);
           // die;
        ...
        //return response()->json($user_device_type);
        if($request->ajax()){
            if($user){
                return response()->json([
                    'status' => true,
