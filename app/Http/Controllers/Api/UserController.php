...
class UserController extends Controller
{
...

    {
        ...
        try {
            ...
            return ResponseBuilder::success(new UserResource($user), __('messages.common.success'));
        } catch (\Exception $e) {
    ...
    public function driverOrderList(Request $request)
    {
        ...
        if (isset($request->current_lat)) {
            $driverLat = $request->current_lat;
        } else {

            $driverLat = isset($user) ? $user->current_lat : '';
        }
        if (isset($request->current_lng)) {
            $driverLng = $request->current_lng;
        } else {
    ...
    public function manageUpdatePrice(Request $request)
    {
        ...
        $productName = '';
        if ((isset($request->vendor_id) && !empty($request->vendor_id)) && (isset($request->vendor_name) && !empty($request->vendor_name)) && (isset($request->shopper_id) && !empty($request->shopper_id)) && (isset($request->product_id) && !empty($request->product_id)) && (isset($request->offer_price) && !empty($request->offer_price)) && (isset($request->price) && !empty($request->price))) {
            $product_details =
    ...
    {
        if ((isset($request->vendor_id) && !empty($request->vendor_id)) && (isset($request->shopper_id) && !empty($request->shopper_id)) && (isset($request->price) && !empty($request->price)) && (isset($request->offer_price) && !empty($request->offer_price)) && (isset($request->product_name) && !empty($request->product_name)) && (isset($request->measurement) && !empty($request->measurement))) {
