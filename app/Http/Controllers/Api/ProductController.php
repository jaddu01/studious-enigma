...
class ProductController extends Controller
{
    ...
    public function getHomedata(Request $request)
    {
        ...
        // $lat = $request->lat;
        // $lng = $request->lng;
        $category =  $this->category->join('categories','categories.id','=','category_translations.category_id')->select('categories.id','image','name','category_translations.slug','banner_image')->where(['locale' => 'en'])->where(['categories.parent_id' => '0'])->where(['categories.status' => '1'])->whereNull('categories.deleted_at')->where('is_show', '1')->orderBy('sort_no', 'ASC')->get();
