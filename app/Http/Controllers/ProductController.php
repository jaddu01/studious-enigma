...
class ProductController extends Controller
{
    ...
    */
    ...
    public function __construct(Request $request, VendorProduct $vendorProduct, Product $product, Offer $offer, User $user,Category $category ,Zone $zone)
    {
...
public function productdeatils(Request $request, $id){
  ...
  if(Auth::user()){ 
    ...
    foreach($vendors as $vk=>$vv){
      ...
      $products = [];
    if (!empty($Product)) {
      // echo "<pre>";     print_r($Product->cart); die;
