...
{
    use Translatable;
    public $translationModel = 'App\AdsTranslation';
    public  $locales;
    use SoftDeletes;
    protected $fillable = [
            ...
            case 'POST':
            {
                ...
                foreach ($this->locales as $locale) {
                    $trans = $trans + [
                            ...
                            'title:'.$locale => "required|unique:ads_translations,title",
                        ];
                }
                return $page + $trans;
            ...
            case 'PUT':
                ...
                foreach ($this->locales as $locale) {
                    $trans = $trans + [
                            ...
                            'title:'.$locale => 'required|unique:ads_translations,title,'.$id.',ads_id',
                        ];
                }
                return $page + $trans;
            case 'PATCH':
