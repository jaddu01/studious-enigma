var uena = (function () {
    var e = $(window).width(),
        ...
        i = function () {
            $("ul#menu>li").on("click", function () {
                const e = $("body").attr("data-sidebar-style");
        ...
        d = function () {
            jQuery(".dz-scroll").each(function () {
                ...
                const t = new PerfectScrollbar("#" + e, { wheelSpeed: 2, wheelPropagation: !0, minScrollbarLength: 20 });
                t.isRtl = !1;
            });
        },
        m = function () {
        ...
        f = function () {
            if (jQuery(".deznav-scroll").length > 0) {
                const e = new PerfectScrollbar(".deznav-scroll");
                e.isRtl = !1;
            }
        },
        p = function () {
    ...
    return {
        init: function () {
            n(), o(), c(), a(), l(), i(), s(), r(), u(), d(), m(), h(), f(), p(), y(), v(), g(), b(), w(), j(), Q(), C(), z();
        },
        load: function () {
            n(), t();
        },
...
jQuery(document).ready(function () {
    $('[data-toggle="popover"]').popover(), uena.init();
}),
