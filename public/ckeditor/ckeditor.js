...
(function () {
        ...
        return {
            define: function (b, d) {
                ...
                if (0 > f.getListenerIndex(d)) {
                    ...
                    n.fn = d;
                    n.priority = k;
                    for (var w = f.length - 1; 0 <= w; w--) if (f[w].priority <= k) return f.splice(w + 1, 0, n), {removeListener: q};
                    f.unshift(n)
                }
            ...
            once: function () {
                ...
                return function (k, n, q) {
                    ...
                    if (f) {
                        var w = f.listeners;
                        if (w.length) for (var w = w.slice(0), A, G = 0; G < w.length; G++) {
                            if (f.errorProof) try {
                                A =
    ...
    (function () {
        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
            ...
            is: function () {
                ...
                f = this.$.offsetWidth;
                var l = a.$.clientHeight, r = a.$.clientWidth;
    ...
    (function () {
        function a(a, b) {
            ...
            f = c.endContainer;
            var e = c.startOffset, D = c.endOffset, g, l = this.guard, r = this.type,
        ...
        CKEDITOR.dom.walker.empty = function (a) {
            return function (b) {
                for (var c = 0, f = b.getChildCount(); c < f; ++c) if (!q(b.getChild(c))) return !!a;
                return !a
            }
        };
    ...
    (function () {
        ...
        function d(a, b, c, d, e) {
            ...
            a.optimizeBookmark();
            var h = 0 === b, q = 1 == b, l = 2 == b;
            b = l || q;
            var r = a.startContainer, J = a.endContainer,
                H = a.startOffset, E = a.endOffset, u, y, v, B, L, n;
            if (l && J.type == CKEDITOR.NODE_TEXT && (r.equals(J) || r.type === CKEDITOR.NODE_ELEMENT && r.getFirst().equals(J))) c.append(a.document.createText(J.substring(H, E))); else {
                ...
                N = c;
                for (P = C; P <= F; P++) if (c = p[P], U = c.getPrevious(), c.equals(O[P])) b && (N = N.getChild(0)); else {
            ...
            trim: function (a, b) {
                ...
                switch (a) {
                    ...
                    case CKEDITOR.ENLARGE_ELEMENT:
                        ...
                        var m = this.getCommonAncestor(), k = this.root, h, q, l, r, J, H = !1, E, u;
                        ...
                        for (l = c(l); l || r;) {
                            ...
                            for (; r;) if (E = !1, r.type == CKEDITOR.NODE_COMMENT) r = r.getPrevious(); else {
                                if (r.type == CKEDITOR.NODE_TEXT) u = r.getText(), d.test(u) && (r = null), E = /[\s\ufeff]$/.test(u); else if ((r.$.offsetWidth > (CKEDITOR.env.webkit ? 1 : 0) || b && r.is("br")) && !r.data("cke-bookmark")) if (H && CKEDITOR.dtd.$removeEmpty[r.getName()]) {
                                    u =
                                        r.getText();
                                    if (d.test(u)) r = null; else for (var y = r.$.getElementsByTagName("*"), v = 0, B; B = y[v++];) if (!CKEDITOR.dtd.$removeEmpty[B.nodeName.toLowerCase()]) {
                                        r = null;
                                        break
                                    }
                                    r && (E = !!u.length)
                        ...
                        for (; l || r;) {
                            ...
                            for (; r;) {
                                E = !1;
                                if (r.type == CKEDITOR.NODE_TEXT) u = r.getText(), g(r, 0) || (r = null), E = /^[\s\ufeff]/.test(u); else if (r.type == CKEDITOR.NODE_ELEMENT) {
                                    if ((0 < r.$.offsetWidth || b && r.is("br")) && !r.data("cke-bookmark")) if (H && CKEDITOR.dtd.$removeEmpty[r.getName()]) {
                                        u =
                                            r.getText();
                                        if (d.test(u)) r = null; else for (y = r.$.getElementsByTagName("*"), v = 0; B = y[v++];) if (!CKEDITOR.dtd.$removeEmpty[B.nodeName.toLowerCase()]) {
                                            r = null;
                                            break
                                        }
                                        r && (E = !!u.length)
                    ...
                    case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
                        ...
                        if (a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS) {
                            l = this.clone();
                            l = new CKEDITOR.dom.walker(l);
                            var t = CKEDITOR.dom.walker.whitespaces(), F = CKEDITOR.dom.walker.bookmark();
                ...
                for (this._.nextNode = null; m;) {
                    ...
                    if (I) m.type == CKEDITOR.NODE_TEXT && e.test(m.getText()) && (I = 0); else {
                        ...
                        if (CKEDITOR.dtd.$block[r] && "false" == m.getAttribute("contenteditable")) {
                            ...
                            if ("br" == r) I = 1; else if (!h && !m.getChildCount() && "hr" != r) {
                                d = m;
                                w = m.equals(x);
                                break
                            }
    ...
    (function () {
        function a(a, b, c, d, e) {
            ...
            for (f in b) {
                l = b[f];
                l = "boolean" == typeof l ? {} : "function" == typeof l ? {match: l} : v(l);
                ...
                for (g in V) {
                    t[g] = h(t[g], u) || null;
                    var p = t, r = O[g], m = h(t[O[g]], u), F = t[g], y = [], B = !0, C = void 0;
                    m ? B = !1 : m = {};
            ...
            for (d = a.length; c < d; ++c) {
                ...
                if (!0 === f.elements ||
                    null === f.elements) e[l ? "unshift" : "push"](f); else for (k in t = f.elements, delete f.elements, t) if (b[k]) b[k][l ? "unshift" : "push"](f); else b[k] = [f]
            }
        }
        ...
        function c(a, b, c) {
            if (!a.match || a.match(b)) {
                ...
                b = b.classes;
                if (a) {
                    for (var d = !1, f = !0 === a, t = b.length; t--;) if (f || a(b[t])) b.splice(t, 1), d = !0;
                    a = d
                } else a = !1;
        ...
        function A(a, b, e, f) {
            ...
            if (f.doCallbacks && a.elementCallbacks) {
                a:{
                    ...
                    for (var v = 0, g = u.length, p; v < g; ++v) if (p = u[v](b)) {
                        u = p;
                        break a
                    }
                    u = void 0
        ...
        function l(a, b, c) {
            ...
            if (y.$empty[d] || !a.children.length) "hr" == d && "br" == b ? a.replaceWith(z()) : (a.parent && c.push({
                ...
                b:{
                    e = y[b];
                    for (var f = 0, t = d.length, l; f < t; ++f) if (l = d[f], l.type == CKEDITOR.NODE_ELEMENT && !e[l.name]) {
                        e = !1;
                        break b
                    }
                    e = !0
        ...
        function J(a, b) {
            var c = b.getDefinition(), d = c.attributes, e = c.styles, f, l, t, v;
            if (a.name != c.element) return !1;
            for (f in d) if ("class" == f) for (c = d[f].split(/\s+/), t = a.classes.join("|"); v = c.pop();) {
                if (-1 == t.indexOf(v)) return !1
            } else if (a.attributes[f] != d[f]) return !1;
            for (l in e) if (a.styles[l] !=
                e[l]) return !1;
            return !0
        }
        ...
        CKEDITOR.filter.prototype = {
            allow: function (b, c, d) {
                ...
                var e = this, f = [], t = this.editor && this.editor.config.protectedSource, v, u = !1,
                    g = {doFilter: !c, doTransform: !0, doCallbacks: !0, toHtml: b};
                a.forEach(function (a) {
                    if (a.type == CKEDITOR.NODE_ELEMENT) {
                        if ("off" == a.attributes["data-cke-filter"]) return !1;
                        if (!b || "span" != a.name || !~CKEDITOR.tools.objectKeys(a.attributes).join("|").indexOf("data-cke-")) if (v = A(e, a, f, g), v & 1) u = !0; else if (v & 2) return !1
                        ...
                        a:{
                            ...
                            c = [];
                            var l, p, r;
                            if (t) for (p = 0; p < t.length; ++p) if ((r = d.match(t[p])) && r[0].length == d.length) {
                                c = !0;
                                break a
                            }
                ...
                for (; p = a.pop();) if (c = p.el, c.parent) switch (r = y[c.parent.name] || y.span, p.check) {
                    case "it":
            ...
            addContentForms: function (a) {
                ...
                if (!this.disabled && a) {
                    ...
                    for (e = 0; e < a.length; ++e) {
                        b = a[e];
                        var f = void 0, l = void 0, t = void 0, v = void 0, g = void 0, p = void 0;
                        c = [];
                ...
                var t = CKEDITOR.tools.clone(e), u = [], g;
                if (!1 !== b && (g = this._.transformations[e.name])) {
                    for (d =
                             0; d < g.length; ++d) r(this, e, g[d]);
                    x(e)
                }
                A(this, t, u, {doFilter: !0, doTransform: !1 !== b, skipRequired: !c, skipFinalValidation: !c});
        ...
        var V = {styles: 1, attributes: 1, classes: 1},
            ...
            C = {styles: /{([^}]+)}/, attrs: /\[([^\]]+)\]/, classes: /\(([^\)]+)\)/}, t = /^cke:(object|embed|param)$/,
            F = /^(object|embed|param)$/, N;
        N = CKEDITOR.filter.transformationsTools = {
            sizeToStyle: function (a) {
                ...
                if ("string" == typeof b) a.name = b; else {
                    var c = b.getDefinition(), d = c.styles, e = c.attributes, f, t, l, v;
                    a.name = c.element;
                    for (f in e) if ("class" == f) for (c = a.classes.join("|"), l = e[f].split(/\s+/); v = l.pop();) -1 == c.indexOf(v) && a.classes.push(v); else a.attributes[f] = e[f];
    ...
    CKEDITOR.scriptLoader = function () {
        ...
        return {
            load: function (b, c, e, g) {
                ...
                h && (b = [b]);
                e || (e = CKEDITOR);
                var k = b.length, n = [], q = [], f = function (a) {
    ...
    CKEDITOR.resourceManager.prototype = {
        add: function (a, d) {
            ...
            for (var c = this.loaded, e = this.registered, g = [], h = {}, k = {}, n = 0; n < a.length; n++) {
                var q = a[n];
                if (q) if (c[q] || e[q]) k[q] = this.get(q); else {
            ...
            var g = {}, h = function (b) {
                a.call(this, b, function (a) {
                    ...
                    for (f in a) {
                        ...
                        if (!d[f]) {
                            if (k.icons) for (var A = k.icons.split(","), G = A.length; G--;) CKEDITOR.skin.addIcon(A[G], k.path + "icons/" + (CKEDITOR.env.hidpi && k.hidpi ? "hidpi/" : "") + A[G] + ".png");
                            d[f] = 1
                        }
    ...
    (function () {
        ...
        function D(a) {
            ...
            CKEDITOR.plugins.load(c.split(","), function (c) {
                ...
                a.plugins = c;
                for (var l in c) {
                    var r = c[l], k = r.lang, h = null, O = r.requires, p;
        ...
        function A(a, b) {
            ...
            for (var e = new CKEDITOR.dom.documentFragment, f, g, k, h = 0; h < a.length; h++) {
                var u = a[h], y = u.startContainer.getAscendant("tr", !0);
                c(u) ? (f ||
        ...
        CKEDITOR.htmlParser.fragment.fromHtml =
            function (g, h, k) {
                    ...
                    if (a(f)) m.push(f); else {
                        ...
                        if ("br" == e) K.push(f); else {
                            for (; !(k = (g = z.name) ? CKEDITOR.dtd[g] || (z._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c, f.isUnknown || z.isUnknown || k[e]);) if (z.isOptionalClose) G.onTagClose(g); else if (e in b && g in b) g = z.children, (g = g[g.length - 1]) && "li" == g.name || D(g = new CKEDITOR.htmlParser.element("li"), z), !f.returnPoint && (f.returnPoint = z), z = g; else if (e in CKEDITOR.dtd.$listItem &&
                                !A(e, g)) G.onTagOpen("li" == e ? "ul" : "dl", {}, 0, 1); else if (g in d && !A(e, g)) !f.returnPoint && (f.returnPoint = z), z = z.parent; else if (g in CKEDITOR.dtd.$inline && m.unshift(z), z.parent) D(z, z.parent, 1); else {
                                f.isOrphan = 1;
                                break
                            }
                            n(e);
                ...
                G.onText = function (a) {
                    ...
                    if (!I && !f["#"] && b in d) G.onTagOpen(e[b] || ""), G.onText(a); else {
                        q();
                        n();
                        l || I || (a = a.replace(/[\t\r\n ]{2,}|[\t\r\n]/g, " "));
        ...
        a.prototype = {
            add: function (a, c, d) {
                ...
                var d = c instanceof CKEDITOR.htmlParser.node || c instanceof CKEDITOR.htmlParser.fragment,
                    g = Array.prototype.slice.call(arguments, 1), h = this.rules, k = h.length, n, q, f, D;
                for (D = 0; D < k; D++) if (d && (n = c.type, q = c.name), f = h[D], !(a.nonEditable && !f.options.applyToAll ||
    ...
    (function () {
            ...
            function v(a, d) {
                return function (e) {
                    if (e.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                        var t = [], l = b(e), v, p;
                        if (l) for (u(l, 1) && t.push(l); l;) g(l) && (v = c(l)) && u(v) && ((p = c(v)) && !g(p) ? t.push(v) : (f(y).insertAfter(v), v.remove())), l = l.previous;
        ...
        CKEDITOR.htmlDataProcessor = function (b) {
            ...
            b.on("toHtml", function (a) {
                a = a.data;
                var c = a.dataValue, e, c = x(c, b), c = f(c, L), c = q(c), c = f(c, B), c = c.replace(O, "$1cke:$2"),
        ...
        var m = /(?:&nbsp;|\xa0)$/, K = "{cke_protected}", z = CKEDITOR.dtd,
            ...
            z.$block), r = {elements: {input: k, textarea: k}}, J = {
        ...
        var u = /<(a|area|img|input|source)\b([^>]*)>/gi,
            ...
            L = /(<textarea(?=[ >])[^>]*>)([\s\S]*?)(?:<\/textarea>)/gi, V = /<cke:encoded>([^<]*)<\/cke:encoded>/gi,
    ...
    (function () {
        ...
        CKEDITOR.htmlParser.element.prototype = CKEDITOR.tools.extend(new CKEDITOR.htmlParser.node, {
            type: CKEDITOR.NODE_ELEMENT, add: b.add, clone: function () {
                ...
                var n, q;
                for (n in h) {
                    for (k = h[n]; ;) if (q = a.onAttributeName(b, n)) if (q != n) delete h[n], n = q; else break; else {
                        delete h[n];
                        break
                    }
                ...
                b && this.filter(b);
                var g = this.name, h = [], k = this.attributes, n, q;
                a.openTag(g, k);
    ...
    (function () {
        ...
        CKEDITOR.editor.prototype.setMode = function (a, b) {
            ...
            if (a != d.mode && h && h[a]) {
                ...
                if (d.mode) {
                    var k = d.checkDirty(), h = d._.previousModeData, n, q = 0;
    ...
    (function () {
        function a(a) {
            var b = a.editor, e = a.data.path, f = e.blockLimit, g = a.data.selection, u = g.getRanges()[0], y;
            ...
            base: CKEDITOR.dom.element, $: function (a, b) {
                ...
                focus: function () {
                    ...
                    if (!this.is("textarea")) {
                        ...
                        if (h) {
                            var k = e.getHead(), u = k.getCustomData("stylesheet");
                        ...
                        this.attachListener(a, "key", function (b) {
                            ...
                            if (0 !== b.getRanges().length) {
                                if (c in
                                    y) {
                                    var e, u = b.getRanges()[0], p = u.startPath(), C, t, k, c = 8 == c;
        ...
        x = function () {
            ...
            function b(c, d) {
                var e, f, u, g, y = [], k = d.range.startContainer;
                e = d.range.startPath();
            ...
            function d(b, c) {
                var e = [], f = b.getChildren(), u = f.count(), g, y = 0, k = v[c], h = !b.is(v.$inline) || b.is("br");
            ...
            var v = CKEDITOR.dtd, B = {
                ...
                dl: 1,
                blockquote: 1
            }, L = {p: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1}, n = CKEDITOR.tools.extend({},
                v.$inline);
            delete n.br;
            return function (B, p, C, t) {
                ...
                if (!t.checkReadOnly()) {
                    ...
                    if (!p.collapsed) {
                        var F = q.block || q.blockLimit, x = p.getCommonAncestor();
                    ...
                    if (m = C) {
                        ...
                        if ((D = m.startPath().block) && (1 != D.getChildCount() || !D.getBogus())) a:{
                            ...
                            if (1 ==
                                ...
                                m = 0;
                                for (t = D.count(); m < t; m++) if (p = D.getItem(m), !p.is(n)) break a;
                    ...
                    if (m) {
                        ...
                        var I, K;
                        p = A.startContainer;
                        var N = B.endPath.elements[0], W, q = N.getPosition(p),
                    ...
                    if (K) for (; G = K.pop();) CKEDITOR.env.needsBrFiller ? G.appendBogus() : G.append(z.document.createText(" "));
    ...
    (function () {
            ...
            if (b) {
                ...
                if (!(d = !c) && (d = !c.isHidden())) {
                    ...
                    var e = c.getRanges(), f = d.getRanges(),
                        ...
                        t = 1 === e.length && e[0].collapsed, f = a(e, !!CKEDITOR.env.webkit) && a(f);
        ...
        var x = "function" != typeof window.getSelection, m = 1, K = CKEDITOR.tools.repeat("​", 7),
            z = new RegExp(K + "( )?", "g"), I, l, r, J = CKEDITOR.dom.walker.invisible(1), H = function () {
                function a(b) {
                    return function (a) {
        ...
        CKEDITOR.on("instanceCreated", function (a) {
            ...
            c.on("contentDom", function () {
                ...
                var k = c.document, p = CKEDITOR.document,
                    h = c.editable(), t = k.getBody(), u = k.getDocumentElement(), l = h.isInline(), y, q;
                ...
                var a = x ? function () {
                    ...
                    var b = function (b, c) {
                        ...
                        for (var e = d.children, f, g, h = b.duplicate(), k = 0,
                                 l = e.length - 1, u = -1, q, n; k <= l;) if (u = Math.floor((k + l) / 2), f = e[u], h.moveToElementText(f), q = h.compareEndPoints("StartToStart", b), 0 < q) l = u - 1; else if (0 > q) k = u + 1; else return {
                            container: d,
                            offset: a(f)
                        };
                        ...
                        if (x) {
                            ...
                            for (m = 0; m < b.length; m++) {
                                ...
                                try {
                                    ...
                                    if (0 <= r.toString().indexOf("NS_ERROR_ILLEGAL_VALUE")) d.collapse(1), F.setEnd(d.endContainer.$, d.endOffset); else throw r;
                                }
                                k.addRange(F)
                            }
                        }
    ...
    (function () {
        ...
        function b(c) {
            ...
            if (c.collapsed) f = K(this, f), c.insertNode(f), c.moveToPosition(f, CKEDITOR.POSITION_BEFORE_END); else {
                ...
                c.trim();
                var n = c.createBookmark(), w = n.startNode, u = n.endNode, r = w, v;
                if (!l) {
                    var x = c.getCommonAncestor(), l = a(w, x), x = a(u, x);
                ...
                for (r.getPosition(u) == CKEDITOR.POSITION_FOLLOWING && (r = 0); r;) {
                    ...
                    if (r.equals(u)) r = null, l = !0; else {
                        ...
                        if (x && m && CKEDITOR.dtd.$block[A]) for (var z = r, y = e(z), E = void 0, H = y.length, I = 0, z = H && new CKEDITOR.dom.range(z.getDocument()); I < H; ++I) {
                        ...
                        if (y) if (E = r.getParent(), y = h, H = g, I = k, !E || !(E.getDtd() || CKEDITOR.dtd.span)[H] && !I || y.parentRule && !y.parentRule(E)) l = !0; else {
                            if (v ||
                                ...
                                for (var A = r, L; (l = !A.getNext(B)) && (L = A.getParent(), q[L.getName()]) && d(L, w, h, O);) A = L;
                                v.setEndAfter(A)
                            }
                        } else l = !0;
...
*/
    ...
    (function () {
        ...
        function y(d) {
            ...
            d.reset();
            var m = 0;
            for (d = g.length; m < d; m++) for (var n = 0, p = g[m].length; n < p; n++) void 0 === k && g[m][n] == e.$ && (k = n), g[m][n] == a.$ && (h = n);
        ...
        function z(d) {
            if (d instanceof CKEDITOR.dom.selection) {
                ...
                a:{
                    ...
                    for (a = 0; k = b[a++];) if ((h = k.getPrevious()) &&
        ...
        function x(d, f, b) {
            ...
            for (f = 0; f < c.length; f++) {
                a = c[f];
                var t = a.getParent(), y = a.getFirst(), v = a.$.colSpan, z = a.$.rowSpan, t = t.$.rowIndex,
                    B = A(g, t, a), w = w + v * z, p = Math.max(p, B - m + v);
                n = Math.max(n, t - l + z);
        ...
        function C(d, f) {
            ...
            if (1 < h) {
                l = Math.ceil(h / 2);
                for (var h =
                    Math.floor(h / 2), c = g + l, e = new CKEDITOR.dom.element(e.$.rows[c]), a = A(a, c), m, c = b.clone(), g = 0; g < a.length; g++) if (m = a[g], m.parentNode == e.$ && g > k) {
                    ...
                    tablecell: {
                        label: c.cell.menu, group: "tablecell", order: 1, getItems: function () {
                            ...
                            return {
                                ...
                                tablecell_merge_down: x(a, "down", !0) ? CKEDITOR.TRISTATE_OFF :
                                    CKEDITOR.TRISTATE_DISABLED,
    ...
    (function () {
        function x(a, b) {
            var c = a.getAscendant("table"), d = b.getAscendant("table"), e = CKEDITOR.tools.buildTableMap(c), h = n(a),
                m = n(b), l = [], k = {}, f, p;
            c.contains(d) && (b = b.getAscendant({td: 1, th: 1}), m = n(b));
            h > m && (c = h, h = m, m = c, c = a, a = b, b = c);
            for (c = 0; c < e[h].length; c++) if (a.$ === e[h][c]) {
                f = c;
                break
            }
            ...
            f > p && (c = f, f = p, p = c);
            for (c = h; c <= m; c++) for (h = f; h <= p; h++) d = new CKEDITOR.dom.element(e[c][h]), d.$ && !d.getCustomData("selected_cell") && (l.push(d), CKEDITOR.dom.element.setMarker(k,
                d, "selected_cell", !0));
            CKEDITOR.dom.element.clearAllMarkers(k);
            return l
        }
        ...
        function v(a) {
            ...
            if (a.data.getTarget().getName) {
                var e = a.editor || a.listenerData.editor, h = e.getSelection(1), m = H(e), l = a.data.getTarget(),
                    k = l && l.getAscendant({td: 1, th: 1}, !0), l = l && l.getAscendant("table", !0), f = {
                        table: 1,
                ...
                (k || l) && J(e, k || l, a);
                "mouseup" === a.name && (CKEDITOR.tools.getMouseButton(a) === CKEDITOR.MOUSE_BUTTON_LEFT && (c(a.data.getTarget()) || b(m, l)) && I(e), g = {active: !1}, CKEDITOR.document.removeListener("mouseup", v))
            }
        }
        ...
        function M(a, b) {
            ...
            var d = a.getSelection(), e = d.createBookmarks(), h = a.document, m = a.createRange(),
                l = h.getDocumentElement().$, k = CKEDITOR.env.ie && 9 > CKEDITOR.env.version,
                f = a.blockless || CKEDITOR.env.ie ? "span" : "div", p, r, B, g;
        ...
        var F = {
            onPaste: function (a) {
                ...
                var d = a.editor, e = d.getSelection(), h = u(e),
                    m = this.findTableInPastedContent(d, a.data.dataValue),
                    l = e.isInTable(!0) && this.isBoundarySelection(e), k, f;
            ...
            isBoundarySelection: function (a) {
                ...
                var d, e = A(a.cells.first,
                    !0), h = a._getTable(), m = {}, l, k, f, p;
                for (f = 0; f < c.length; f++) for (l = new CKEDITOR.dom.element(h.$.rows[a.rows.first.$.rowIndex + f]), p = 0; p < c[f].length; p++) if (k = new CKEDITOR.dom.element(c[f][p]), d = b[f] && b[f][p] ? new CKEDITOR.dom.element(b[f][p]) : null, k && !k.getCustomData("processed")) {
            ...
            getCellsBetween: x, keyboardIntegration: function (a) {
                ...
                c.attachListener(c, "keydown", function (a) {
                    function c(b, e) {
                        ...
                        var f = a.createRange(), h = CKEDITOR.dom.range.mergeRanges(e);
                        CKEDITOR.tools.array.forEach(h, function (a) {
                            a.enlarge(CKEDITOR.ENLARGE_ELEMENT)
                        });
                        var r = h[0].getBoundaryNodes(), g = r.startNode, r = r.endNode;
                        if (g && g.is && g.is(m)) {
                    ...
                    delete m.th;
                    return function (l) {
                        var k = l.data.getKey(), f, m = 37 === k || 38 == k, g, n, q;
                        if (h[k] && (f = a.getSelection()) && f.isInTable() && f.isFake) if (g = f.getRanges(), n = g[0]._getTableElement(), q = g[g.length -
                            1]._getTableElement(), l.data.preventDefault(), l.cancel(), 8 < k && 46 > k) g[0].moveToElementEditablePosition(m ? n : q, !m), f.selectRanges([g[0]]); else {
                ...
                c.attachListener(c, "keypress", function (d) {
                    var c = a.getSelection(), h = d.data.$.charCode || 13 === d.data.getKey(), g;
