<div class="modal fade" id="addProductModal" data-controls-modal="addProductModal" role="dialog" data-backdrop="static"
    data-keyboard="false">
        ...
        <div class="modal-content">
            ...
            <form id="addNewProductForm">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-6 product-image-uploder">
                            ...
                            <div class="text-center">
                                <img src="{{ asset('public/assets/icons/cloud-upload-fill.svg') }}"
                                    id="productImgUploader">
                            </div>
                            <div class="imageViwer display-hide">
                    ...
                    <div class="row mt-3">
                        <div class="col-md-6">
                            ...
                            <select class="form-control select2-related-products custom-form-input"
                                id="related_products" name="related_products[]"
                                placeholder="Search Related Products Name">
                            </select>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-control select2-variant-products custom-form-input"
                                id="variant_products" name="variant_products[]"
                                placeholder="Search Variant Products Name">
                            </select>
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-success" id="addproductModalBtn">Add Product</button>
