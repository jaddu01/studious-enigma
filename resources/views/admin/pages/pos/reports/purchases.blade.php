    ...
    <script>
        ...
        $(function() {
            ...
            $('#getData').click(function(){
                getPurchaseReportData($('#purchase_date').val());
            })
        ...
        function getPurchaseReportData(date=null) {
            var html='';
            $('#tbody').html("<tr><td colspan='7' class='text-center'><img style='width:50%;height:auto' src='{{asset('public/upload/loader.gif')}}'></td></tr>");
            $('#tfoot').html('<tr><th colspan="6">Total Amount</th><th>0</th></tr>');
            $.ajax({
                data:{date:date},
                type:"POST",
                ...
                success: function( data ) {
                    if(data.total.total_amount>0){
                        ...
                        $('#tfoot').html('<tr><th colspan="6">Total Amount</th><th>'+data.total.total_amount+'</th></tr>');
