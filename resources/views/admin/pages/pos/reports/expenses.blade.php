...
@push('scripts')
    ...
    <script>
        ...
        function getExpensesReportData(date=null) {
            var html='';
            $('#tbody').html("<tr><td colspan='4' class='text-center'><img style='width:50%;height:auto' src='{{asset('public/upload/loader.gif')}}'></td></tr>");
            ...
            $.ajax({
                ...
                success: function( data ) {
                    if(data.total.total_amount>0){
                        ...
                        $('#tfoot').html('<tr><th colspan="3">Total Expenses</th>><th>'+data.total.total_amount+'</th></tr>');
