                            ...
                            <div class="panel-body">
                                <form role="form" class="form-inline" id="search-form" method="POST" autocomplete="off">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="expense_date" name="expense_date" class="form-control datepicker">
                                    </div>
                                    <div class="form-group">
    ...
    <script>
        ...
        $(function() {
            ...
            $('#getData').click(function(){
                getExpensesReportData($('#expense_date').val());
            })
        ...
        function getExpensesReportData(date=null) {
            var html='';
                    ...
                    if(data.total.total_amount>0){
                        data.data.forEach((value)=> {
                            ...
                            if(value.description.length>0) {
                                html1+='<table style="border:none;">';
                                value.description.forEach((value1)=> {
                                    html1+='<tr>';
                                    html1+='<td style=" width:300px">'+value1.title+' -'+value1.description+'</td>';
                                    html1+='<td style="text-align:right; width:100px">'+value1.price+'</td>';
                                    html1+='</tr>';
                                });
                                html1+='</table>'
                            }
                            html1 = html1.replace('undefined','');
                            html+='<tr>';
                            html+='<td>'+html1+'</td>';
                        ...
                        $('#tfoot').html('<tr><th>Total Amount</th><th></th><th>'+data.total.total_amount+'</th></tr>');
