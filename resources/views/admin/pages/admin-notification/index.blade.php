...
<script src="{{asset('public/assets/moment/min/datetime-moment.js')}}"></script>
       ...
       autoWidth:false,
        ...
        rowCallback: function (row, data, index) {
            ...
            if (dateCell !== undefined && dateCell > 0) {
                let date = moment.unix(dateCell).format('DD/MM/Y'); 
                $('td:eq(4)', row).html(date);
            }
        },
        columns: [
            { data: 'user', name: 'user',orderable: false, searchable: false },
            { data: 'message_heading', name: 'message_heading',orderable: false },
