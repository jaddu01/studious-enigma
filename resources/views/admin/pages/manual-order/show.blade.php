                        ...
                        <div class="x_content">
                            ...
                            <div class="item form-group{{ $errors->has('customer_phone') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    {!!  Form::text('customer_phone', null, array('placeholder' => 'Customer Phone','class' => 'form-control priceNum col-md-7 col-xs-12','maxLength'=>10 )) !!}
                            ...
                            <input type="hidden" id="added_product_ids" value="0">
                            <input type="hidden" id="mim_amount_for_free_delivery" value="{{$mim_amount_for_free_delivery}}">
                ...
                <div class="modal-body">
                    ...
                    <div class="row item form-group{{ $errors->has('vendor_product_id') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                             {!!  Form::select('vendor_product_id',[], null, array('class' => 'form-control select2-multiple  col-md-10 col-xs-12','placeholder'=>'product','id'=>'vendor_product_id','required')) !!}
