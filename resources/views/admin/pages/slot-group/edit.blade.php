                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            {!! Form::model($slotGroup,['route' => ['slot-group.update',$slotGroup->id],'method'=>'post','class'=>'form-horizontal form-label-left validation','enctype'=>'multipart/form-data']) !!}
                            {{method_field('put')}}

                            {{csrf_field()}}
                            <span class="section">Edit Slot Group</span>
