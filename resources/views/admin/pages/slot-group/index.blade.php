    ...
    <script>
        ...
        $(function() {
            ...
            window.table=$('#users-table').DataTable({
                ...
                serverSide: true,
                ajax: '{!! route('slot-group.datatable') !!}',
                ...
                columns: [
                    { data: 'Slno', name: 'Slno' },
                    { data: 'name', name: 'name' },
                    { data: 'number_of_slot', name: 'number_of_slot' },
                    { data: 'slot_ids', name: 'slot_ids' },
        ...
        function changeStatus(id,status){
            $.ajax({
                ...
                type: "PATCH",
                url: "{!! route('admin.slot-group.status') !!}",
                headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
                success: function( data ) {
                    window.table.draw();
                    new PNotify({
