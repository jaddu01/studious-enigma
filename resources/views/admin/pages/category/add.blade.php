                        ...
                        <div class="x_content">
                            ...
                            @foreach (config('translatable.locales') as $locale)
                                ...
                                <div class="item form-group {{ $errors->has('banner_image') ? ' has-error' : '' }}">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="email">Banner Image In
                                        {{ $locale }}<span class="required">*</span>
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <select name="parent_id" id="parent_id" class="form-control col-md-7 col-xs-12">
                                        ...
                                        @foreach ($categories as $key => $value)
                                            <option value="{{ $value->id }}" class="optionGroup">{{ $value->name }}
                                            </option>
                            ...
                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="is_checkout">Show Category In Checkout Page
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">

                                    <input name="is_checkout" type="checkbox" value="1">
