                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                                ...
                                {!! Form::open(['route' => 'offer.store','method'=>'post','class'=>'form-horizontal form-label-left validation','enctype'=>'multipart/form-data']) !!}
                          ...
                          {{--  <div class="item form-group {{ $errors->has('user_id') ? ' has-error' : '' }}">
                            ...
                            <div class="item form-group {{ $errors->has('offer_type') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    {!!  Form::select('offer_type', Helper::$offer_type,null, array('class' => 'form-control col-md-7 col-xs-12')) !!}
                            ...
                            <div class="item form-group{{ $errors->has('offer_value') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    {!!  Form::number('offer_value', null, array('placeholder' => 'offer value','class' => 'form-control col-md-7 col-xs-12' )) !!}
                            ...
                            <div class="item form-group{{ $errors->has('to_time') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    {!!  Form::text('to_time', null, array('placeholder' => 'To time','class' => 'form-control col-md-7 col-xs-12 datepicker' )) !!}
                            ...
                            <div class="item form-group{{ $errors->has('from_time') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    {!!  Form::text('from_time', null, array('placeholder' => 'To time','class' => 'form-control col-md-7 col-xs-12 datepicker' )) !!}
