...
@section('content')
                            ...
                            <div class="panel-body">
                                <form role="form" class="form-inline" id="search-form" method="POST" autocomplete="off">
                                    <div class="form-group">
                                        ...
                                        {!!  Form::select('order_type',['all'=>'All order','today'=>'Today Order'],null, array('class' => 'form-control ')) !!}
                                        </div>
                                        <div class="form-group">
                                      ...
                                      {{--  {!!  Form::select('user_id', $users,$user_id, array('class' => 'form-control select2-multiple','placeholder'=>'Vendor')) !!}
                                        ...
                                        <input type="text" id="from_date" name="delivery_from_date" class="form-control datepicker"></div>
                                        <div class="form-group">
  ...
  <div class="modal-content" style="width:20%">
   ...
   // print_r(Helper::$order_status);
    ...
    <p><input name="order_status" type="checkbox" value="{{$key}}"> <label for="{{$data}}">{{$data}}</label></p>
...
$(function() {
 $('input:checkbox').click(function() {
    ...
    window.table=$('#users-table').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: '{!! route('order.datatable') !!}?user_id={{ $user_id or '' }}',
            data: function (d) {
