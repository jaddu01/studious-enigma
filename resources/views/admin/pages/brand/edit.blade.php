                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            {!! Form::model($brand,['route' => ['brand.update',$brand->id],'method'=>'post','class'=>'form-horizontal form-label-left validation','enctype'=>'multipart/form-data']) !!}
                                {{csrf_field()}}
                                {{method_field('put')}}
                                ...
                                @foreach(config('translatable.locales') as $locale)
                                    ...
                                    <div class="item form-group {{ $errors->has('image') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <img src="{{$brand->{'image:'.$locale} }}" height="75" width="75"/>
