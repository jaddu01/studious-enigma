...
@section('content')
<?php if($offer->offer_type == 'percentages' ) {
$max = '100';}else{ $max = '';}?>
    <!-- page content -->
        ...
        <div class="">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                                {!! Form::model($offer,['route' => ['offer.update',$offer->id],'method'=>'post','class'=>'form-horizontal form-label-left validation','enctype'=>'multipart/form-data']) !!}
                                {{csrf_field()}}
                                {{method_field('put')}}
                            ...
                            <div class="item form-group{{ $errors->has('offer_value') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    {!!  Form::number('offer_value', null, array('placeholder' => 'offer value','class' => 'form-control col-md-7 col-xs-12' ,'min' => '1', 'max' => $max)) !!}
                            ...
                            <div class="item form-group {{ $errors->has('image') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
<img src="{{ $offer->images->first()->name or ''}}" height="75" width="75">
                                ...
                                <div class="item form-group {{ $errors->has('status') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        {!!  Form::select('status', ['1'=>'Active','0'=>'Inactive'],$offer->status, array('class' => 'form-control col-md-7 col-xs-12')) !!}
