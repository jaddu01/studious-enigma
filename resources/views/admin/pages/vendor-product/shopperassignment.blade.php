...
@section('title', ' Shopper Assignment |')
@push('css')
...
@section('content')
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
						...
						{!! Form::open (array('route' => 'vendor-product.shopperassignment', 'class' => 'form-inline','method' => 'post', 'novalidate' => 'novalidate','autocomplete'=>'off' ) ) !!}	
							
							
                        <input type='text' class='datepicker' name="date">
                        <button class="btn btn-primary" type="submit">Apply filter</button>
                         <a class="btn btn-primary" href="{!! route('vendor-product.shopperassignment') !!}">Cancel filter</a>
                        {!! Form::close () !!}
 ...
 <div id="myModal" class="modal">
  ...
  <div class="modal-content">
    ...
    <label class="control-label col-md-12 col-sm-12 col-xs-12" for="name">Select Shopper
                        </label>
    <div class="row item form-group">
     {!!  Form::select('shopper_id', $shopperList, array('class' => 'form-control ','placeholder'=>'Shoppers','id'=>"shopper_id")) !!}
    </div>
	<input type="hidden" value="" name="order_id">
	<input type="hidden" value="shopper" name="type">
    <div class="row item form-group">
 		<button  class="btn btn-success" id="assign_button" >Save</button>
    </div>
	{!! Form::close() !!}
  </div>
...
function changeDriver(id){
    ...
    $("select[name=shopper_id]").attr('id','shopper_id_'+id);
    //var tr = "#tr_"+id;
    ...
    $.ajax({
                ...
                success: function( response ) {
                    ...
                    if(response.status == 'true'){
                       // $('[name=driver_id]').val( response.data.driver_id );
                        ...
                        //$('#shopper_id_'+id+' option[value='+response.data.shopper_id+']').attr('selected','selected');
