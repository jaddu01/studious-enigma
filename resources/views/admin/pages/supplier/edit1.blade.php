                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                                ...
                                {!! Form::model($supplier,['route' => ['supplier.update',$supplier->id],'method'=>'post','class'=>'form-horizontal form-label-left validation','enctype'=>'multipart/form-data']) !!}
                                ...
                                @foreach(config('translatable.locales') as $locale)
                                    ...
                                    <div class="item form-group {{ $errors->has('status') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            ...
                                            {!!  Form::select('status', ['1'=>'Active','0'=>'Inactive'],null, array('placeholder' => 'Status','class' => 'form-control col-md-7 col-xs-12','id'=>'status' )) !!}
