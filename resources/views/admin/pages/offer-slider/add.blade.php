...
@section('title', 'Add offer slider |')
@push('css')
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                                ...
                                {!! Form::open(['route' => 'offer-slider.store','method'=>'post','class'=>'form-horizontal form-label-left validation','enctype'=>'multipart/form-data','id'=>'slider_form']) !!}
                                {{csrf_field()}}
                                <span class="section">Add offer slider</span>
                                ...
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="email">Load Zone <span class="required">*</span>
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        {!!  Form::select('zone_id[]',$zones,null, array('class' => 'form-control multiselect-ui','id'=>'zone_id','multiple'=>'multiple')) !!}
                            ...
                            <div id="link_div" class="item form-group{{ $errors->has('link') ? ' has-error' : '' }}">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Link <span class="required">*</span>
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">

                                    {!!  Form::text('link', null, array('placeholder' => 'link','class' => 'form-control col-md-7 col-xs-12','id'=>'link' )) !!}
                                    @if ($errors->has('link'))
                                        <span class="help-block">
