...
@section('title', 'Edit Offer Slider')
@push('css')
        ...
        <div class="">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                                {!! Form::model($slider,['route' => ['offer-slider.update',$slider->id],'method'=>'post','class'=>'form-horizontal form-label-left validation','enctype'=>'multipart/form-data','id'=>'slideredit_form']) !!}
                                {{csrf_field()}}
                                {{method_field('put')}}
                                ...
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="email">Load Zone <span class="required">*</span>
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        {!!  Form::select('zone_id[]',$zones,$selectedZone, array('class' => 'form-control multiselect-ui','placeholder'=>'Select Zone','id'=>'zone_id','multiple'=>'multiple')) !!}
                            ...
                            <div  id="link_div" class="item form-group{{ $errors->has('link') ? ' has-error' : '' }}"  style="<?php if($slider->link_type=='internal'){?>
                                display: none;
                                <?php }else{?>
                                display: block;
                                <?php } ?>">
                            ...
                            <div id="internal_div" style="
                             <?php if($slider->link_type=='internal'){?>
                                display: block;
                                <?php }else{?>
                                display: none;
                                <?php } ?>">
