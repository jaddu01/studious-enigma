...
<div class="x_content ">
     <div id="Add" class="tab-pane fade in active">
         <h2>Products Add Import</h2>
                {!! Form::open(['route' => 'admin.product.importExcel','method'=>'post','class'=>'form-horizontal form-label-left validation importform','enctype'=>'multipart/form-data']) !!}
                {{csrf_field()}}
                @if ($errors->any())
             ...
             <!--    <input type="hidden" value="{{ url('/')}}" id="baseurl"/>  -->
                ...
                <div class="col-md-6 col-md-offset-3">
                 ...
                 <a href="{{asset('public/samplefiles/importproducts.xlsx')}}">Sample File</a>
                </div>
                </div>
                {!! Form::close() !!}
        </div> 
