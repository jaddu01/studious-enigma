...
@section('title', 'Analytic Report/SlotTimes |')
@push('css')
        ...
        <div class="">
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Analytic Report/SlotTimes</h2>
                        ...
                        <div class="x_content">
                            <div class="panel-body">
                                <form role="form" class="form-inline" id="search-form" method="POST" autocomplete="off">
                                        ...
                                        <div class="form-group">
                                        {!!  Form::select('weekday', $weekdays,null, array('class' => 'form-control select2-multiple','placeholder'=>'Weekday','id'=>'weekday')) !!}
                                        </div>
                                        <div class="form-group">
    ...
    window.table=$('#users-table').DataTable({
      dom: 'lBfrtip',
       ...
       /* scrollX: true,
        ...
        serverSide: true,
        ajax: {
            url: '{!! route('anaylitics.datatable.slot-times') !!}?user_id={{ $user_id or '' }}',
            data: function (d) {
                d.zone_id = $('[name=zone_id]').val();
                d.weekday = $('[name=weekday]').val();
      ...
      oSearch: {"sSearch": '<?php echo isset($_GET['order_status']) ? $_GET['order_status'] : '' ?>' },
      columns: [
            { data: 'slot_times', name: 'slot_times'},
