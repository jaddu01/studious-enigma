                        ...
                        <div class="x_content">
                            ...
                            <table class="table table-striped table-bordered" id="users-table">
                                ...
                                <tr>
                                    ...
                                    <th>Vendor Name</th>
                                    <th>Zone Name</th>
                                    <th>Order Value (Including Service Fee)</th>
                                    <th>Product value (Excluding Service Fee)</th>
                                    <th>Commission</th>
                                    <th>Service Charge</th>
                                   <th>Payable to Zc</th>
                                    <th>Receivable from Zc</th>
                                    <th>Net</th>
  ...
  <hr>
                             <div class="panel-body">
                                <div align="right" class="col-md-8" >
                                    <h3>Total (Payable)/Receivable from Zc</h3> </div>
                                <div class="col-md-4" > 
                                    <input type="text" value="{{$totalpayment}}" disabled="disabled" style="text-align:center" > </div>
...
$(function() {
    ...
    window.table=$('#users-table').DataTable({
      dom: 'lBfrtip',
        ...
        serverSide: true,
        ajax: {
            url: '{!! route('anaylitics.datatable.payment') !!}?user_id={{ $user_id or '' }}',
            data: function (d) {
      ...
      columns: [
            ...
            { data: 'order_charge', name: 'order_charge'},
            { data: 'product_charge', name: 'product_charge'},
            { data: 'commission', name: 'commission'},
            { data: 'service_charge', name: 'service_charge'},
            { data: 'payable_amount', name: 'payable_amount'},
            { data: 'recived_amount', name: 'recived_amount'},
