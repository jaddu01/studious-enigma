...
@section('title', 'Analytic Report/Store |')
@push('css')
                        ...
                        <div class="x_content">
                            <div class="panel-body">
                                <form role="form" class="form-inline" id="search-form" method="POST" autocomplete="off">
                                        ...
                                        <div class="form-group">
                                          {!!  Form::select('vendor_id', $vendors,null, array('class' => 'form-control select2-multiple','placeholder'=>'Store','id'=>'vendor_id')) !!}
                                        </div>
						                <div class="form-group">
