                    ...
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                           ...
                           <!--  <div class="item form-group{{ $errors->has('app_name') ? ' has-error' : '' }}">
                            ...
                            <div class="item form-group{{ $errors->has('youtube') ? ' has-error' : '' }}">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">youtube <span class="required">*</span>
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">

                                    {!!  Form::text('youtube', null, array('placeholder' => 'youtube','class' => 'form-control col-md-7 col-xs-12' )) !!}
                            ...
                            <div class="item form-group{{ $errors->has('referral_amount') ? ' has-error' : '' }}">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Referral Amount <span class="required">*</span>
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">

                                    {!!  Form::text('referral_amount', null, array('placeholder' => 'Referral Amount','class' => 'form-control col-md-7 col-xs-12' )) !!}
                                    @if ($errors->has('referral_amount'))
                                        <span class="help-block">
                                                <strong>{{ $errors->first('referral_amount') }}</strong>
                                            </span>
                                    @endif
                                </div>
                            </div>

                            <div class="item form-group{{ $errors->has('referred_by_amount') ? ' has-error' : '' }}">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Referred By Amount <span class="required">*</span>
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">

                                    {!!  Form::text('referred_by_amount', null, array('placeholder' => 'Referred By Amount ','class' => 'form-control col-md-7 col-xs-12' )) !!}
                                    @if ($errors->has('referred_by_amount'))
                                        <span class="help-block">
                                                <strong>{{ $errors->first('referred_by_amount') }}</strong>
                                            </span>
                                    @endif
                                </div>
                            </div>

                            <div class="item form-group{{ $errors->has('refer_limit') ? ' has-error' : '' }}">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Refer Limit 
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">

                                    {!!  Form::text('refer_limit', null, array('placeholder' => 'Refer Limit ','class' => 'form-control col-md-7 col-xs-12' )) !!}
                                    @if ($errors->has('refer_limit'))
                                        <span class="help-block">
                                                <strong>{{ $errors->first('refer_limit') }}</strong>
                                            </span>
                                    @endif
                                </div>
                            </div>
