        ...
        <div class="">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                                {!! Form::model($ads_cat,['route' => ['update.category-image-ads',$ads_cat->id],'method'=>'post','class'=>'form-horizontal form-label-left validation','enctype'=>'multipart/form-data','id'=>'slideredit_form']) !!}
                                {{csrf_field()}}
                                {{method_field('put')}}
                                <span class="section">Edit Category Ads</span>
                            ...
                            @foreach(config('translatable.locales') as $locale)
                                ...
                                <div class="item form-group {{ $errors->has('image') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <img src="{{$ads_cat->{'image:'.$locale} }}" height="75" width="75"/>
                            ...
                            <div  id="link_div" class="item form-group{{ $errors->has('link') ? ' has-error' : '' }}" style="<?php if($ads_cat->link_type=='internal'){?>
                                display: none;
                                <?php }else{?>
                                display: block;
                                <?php } ?>">
                             ...
                             <?php if($ads_cat->link_type=='internal'){?>
                                display: block;
                                <?php }else{?>
                                display: none;
                                <?php } ?>">
                               ...
                               <!--  <div class="item form-group {{ $errors->has('product_id') ? ' has-error' : '' }}">
                                ...
                                <div class="item form-group {{ $errors->has('status') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        {!!  Form::select('status', ['1'=>'Active','0'=>'Inactive'],$ads_cat->status, array('class' => 'form-control col-md-7 col-xs-12')) !!}
