                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                                ...
                                {!! Form::open(['route' => 'slider.store','method'=>'post','class'=>'form-horizontal form-label-left validation','enctype'=>'multipart/form-data','id'=>'slider_form']) !!}
                                ...
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="email">Load Zone <span class="required">*</span>
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        {!!  Form::select('zone_id[]',$zones,null, array('class' => 'form-control multiselect-ui','id'=>'zone_id','multiple'=>'multiple', 'required')) !!}
