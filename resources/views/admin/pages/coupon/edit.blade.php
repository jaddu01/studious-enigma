...
@section('content')
<?php if($coupon->coupon_type == 'percentages' ) {$max = '100';}else{ $max = '';}?>
    <!-- page content -->
        ...
        <div class="">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                                {!! Form::model($coupon,['route' => ['coupon.update',$coupon->id],'method'=>'post','class'=>'form-horizontal form-label-left validation','enctype'=>'multipart/form-data']) !!}
                                {{csrf_field()}}
                                {{method_field('put')}}
                                <span class="section">Edit coupon</span>
                            ...
                            <div class="item form-group{{ $errors->has('coupon_value') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    {!!  Form::number('coupon_value', null, array('placeholder' => 'coupon value','class' => 'form-control col-md-7 col-xs-12' ,'min' => '1', 'max' => $max)) !!}
                            ...
                            <div class="item form-group{{ $errors->has('from_time') ? ' has-error' : '' }}">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Form Time <span class="required">*</span>
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">

                                    {!!  Form::text('from_time', null, array('placeholder' => 'To time','class' => 'form-control col-md-7 col-xs-12 datepicker','id'=>'from_time' )) !!}
                            ...
                            <div class="item form-group{{ $errors->has('from_time') ? ' has-error' : '' }}">
                                ...
                                <div class="item form-group {{ $errors->has('status') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        {!!  Form::select('status', ['1'=>'Active','0'=>'Inactive'],$coupon->status, array('class' => 'form-control col-md-7 col-xs-12')) !!}
