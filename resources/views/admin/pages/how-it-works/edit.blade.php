...
@section('title', 'Edit How It Works Image')
@push('css')
        ...
        <div class="">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                                {!! Form::model($slider,['route' => ['how-it-works.update',$slider->id],'method'=>'post','class'=>'form-horizontal form-label-left validation','enctype'=>'multipart/form-data','autocomplete'=>'off']) !!}
                                {{csrf_field()}}
                                {{method_field('put')}}
                                <span class="section">Edit How It Works Image</span>
