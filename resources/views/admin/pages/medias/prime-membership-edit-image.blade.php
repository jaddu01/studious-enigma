...
@section('title', 'Edit Media (Prime Membership)')
@push('css')
        ...
        <div class="">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                                {!! Form::model($slider,['route' => ['admin.media.prime-membership-image.update',$slider->id],'method'=>'post','class'=>'form-horizontal form-label-left validation','enctype'=>'multipart/form-data','autocomplete'=>'off']) !!}
                                {{csrf_field()}}
                                {{method_field('put')}}
                                <span class="section">Edit Media (Prime Membership)</span>
                            ...
                            @foreach(config('translatable.locales') as $locale)
                                ...
                                @endforeach
                                {{ Form::hidden('media_type', 'prime_membership', array('id' => 'media_type')) }}
