...
@section('title', ' Media (Prime Membership) |')
@push('css')
...
function deleteRow(id){
    $.ajax({
        ...
        type: "DELETE",
        url: "{{ url('admin/medias/delete') }}/"+id,
