                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            {!! Form::open(['route' => 'membership.store','method'=>'post','class'=>'form-horizontal form-label-left validation','enctype'=>'multipart/form-data','id'=>'product_form']) !!}
                            {{csrf_field()}}
                            <span class="section">Add Membership</span>
                            <div class="item form-group {{ $errors->has('user_id') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    {!!  Form::text('name',null, array('class' => 'form-control col-md-7 col-xs-12','id'=>'name')) !!}
                        ...
                        @endif
                         ...
                         <div class="item form-group {{ $errors->has('duration') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-3 col-sm-3 col-xs-12">
                                    {!!  Form::number('duration_value','1', array('class' => 'form-control col-md-6 col-xs-12','min'=>'1' ,'id'=>"duration_value")) !!}
                                      </div>
                               <div class="col-md-3 col-sm-3 col-xs-12">
                                    {!!  Form::select('duration_class', $durations,null, array('class' => 'form-control col-md-6 col-xs-12','id'=>"duration_class")) !!}
                                    <input type="hidden" name="duration" id="duration" value="1 day">
                        ...
                        <div class="item form-group {{ $errors->has('offer_price') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    {!!  Form::text('offer_price',null, array('class' => 'form-control col-md-7 col-xs-12','id'=>'offer_price')) !!}
                                    {{ Form::filedError('price') }}
                                </div>
                            </div>
                            <div class="item form-group {{ $errors->has('min_order_price') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    {!!  Form::text('min_order_price',null, array('class' => 'form-control col-md-7 col-xs-12','id'=>'min_order_price')) !!}
                            ...
                            <div style="display: none;" class="item form-group{{ $errors->has('free_delivery') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                {!!  Form::checkbox('free_delivery',null,'1', array('class' => 'form-control w-10-p' )) !!}
