        ...
        <div class="">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                                {!! Form::model($city,['route' => ['city.update',$city->id],'method'=>'post','class'=>'form-horizontal form-label-left validation','enctype'=>'multipart/form-data']) !!}
                                {{csrf_field()}}
                                {{method_field('put')}}
                            ...
                            @foreach(config('translatable.locales') as $locale)
                                ...
                                <div class="item form-group {{ $errors->has('status') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        {!!  Form::select('status', ['1'=>'Active','0'=>'Inactive'],$city->status, array('class' => 'form-control col-md-7 col-xs-12')) !!}
